...
//  response body, so a Carrd script tag pointed at the workers.dev URL can
//  load it.
//
//  WIDGET_SOURCE below is the widget code as a real, readable, multi-line
//  template literal. Backslashes, backticks, and ${ sequences in the
//  original code are escaped so the outer literal doesn't corrupt them --
//  this file was generated by a script that also round-trip verifies the
//  escaping byte-for-byte, not hand-edited.
//
//  The widget code itself runs client-side (uses the DOM) -- it must stay
//  inside this string, never be the Worker's own top-level code.
//
//  DEPLOY: Cloudflare dashboard -> was-artie-widget -> Edit code -> paste
//  this whole file -> Save and Deploy.
// ===========================================================================
